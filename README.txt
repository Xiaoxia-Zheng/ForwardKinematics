...
Forward Kinematics
------------------
There are two parts to this project, (1) designing data structures to store 
the skeleton hierarchy and pose data and mapping the pose data given in local 
coordinate frames to world space. (2)interpolate between each pair of poses if 
the command line switch "-i nframes" is passed to the program, where nframes 
are interpolated between each pair of poses. 
...
ogre-skeleton.bf	.bf "bone forest" file containing the skeleton description. 
					...
					parent joints
pose.dmat			"dense matrix" containing the poses. Each pose is given as a set of 
					69 "Euler angles" for 23 3-degree-of-freedom ball-and-socket joints.
